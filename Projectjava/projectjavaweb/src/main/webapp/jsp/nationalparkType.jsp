...
<title>National Park Type</title>
...
<body>
    ...
    <h1 style="font-weight: bold; margin: 50px;">สถานที่ท่องเที่ยวประเภทอุทยานแห่งชาติ</h1>
    
    <c:forEach var="blog" items="${nationalparkBlogs}">
<div class="container">
			<div>
				<h1
