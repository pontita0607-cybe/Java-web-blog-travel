...
<title>Market Walking Street Type</title>
...
<body>
    ...
    <h1 style="font-weight: bold; margin: 50px;">สถานที่ท่องเที่ยวประเภทตลาด/ถนนคนเดิน</h1>
    
    <c:forEach var="blog" items="${marketwalkingstreetBlogs}">
<div class="container">
			<div>
				<h1
			...
			<a class="Bookmark" href="/bookmark/${blog.id}"><span class="material-symbols-outlined">bookmark</span></a>
			<br>
