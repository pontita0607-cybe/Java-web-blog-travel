					...
					<div class="card-body p-4">
						...
						<div class="form-outline mb-4">
							<form action="/addComment" method="post">
								...
								<input name="comment" type="text" id="addANote" class="form-control"
									placeholder="What do you think?" /> <input type="submit"
									value="Submit" class="form-submit">
							</form>
						</div>
